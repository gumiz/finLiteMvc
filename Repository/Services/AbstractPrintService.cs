...
namespace Repository.Services
{
	public abstract class AbstractPrintService : IPrintService
	{
		...
		private void GetHtmlBase(int clientId)
		{
			...
			var client = Factory.GetClientsService().GetClients().FirstOrDefault(x => x.ClientId.Equals(clientId));
			var user = client != null ? client.Description : "";
